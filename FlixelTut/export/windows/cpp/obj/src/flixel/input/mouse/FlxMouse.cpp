		...
		if ((::Std_obj::is(Graphic,hx::ClassOf< ::Class >()))){
			...
			if ((::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_legacy::display::BitmapData >()))){
				...
				if ((::Std_obj::is(Graphic,hx::ClassOf< ::String >()))){
					HX_STACK_LINE(184)
					::openfl::_legacy::display::BitmapData _g5;		HX_STACK_VAR(_g5,"_g5");
					HX_STACK_LINE(184)
					{
						HX_STACK_LINE(184)
						...
						if (((bd == null()))){
							HX_STACK_LINE(184)
							::openfl::_legacy::display::BitmapData _g4 = ::openfl::_legacy::Assets_obj::getBitmapData(id,false);		HX_STACK_VAR(_g4,"_g4");
							HX_STACK_LINE(184)
							bd = _g4;
						}
						HX_STACK_LINE(184)
					...
					HX_STACK_LINE(184)
					::openfl::_legacy::display::Bitmap _g6 = ::openfl::_legacy::display::Bitmap_obj::__new(_g5,null(),null());		HX_STACK_VAR(_g6,"_g6");
					HX_STACK_LINE(184)
					this->_cursor = _g6;
				}
				else{
					HX_STACK_LINE(188)
					::flixel::input::mouse::_FlxMouse::GraphicCursor _g7 = ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null());		HX_STACK_VAR(_g7,"_g7");
					HX_STACK_LINE(188)
					::openfl::_legacy::display::Bitmap _g8 = ::openfl::_legacy::display::Bitmap_obj::__new(_g7,null(),null());		HX_STACK_VAR(_g8,"_g8");
					HX_STACK_LINE(188)
					this->_cursor = _g8;
				}
			}
