...
int FlxBaseAnimation_obj::set_curIndex( int Value){
	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","set_curIndex",0x05c5f580,"flixel.animation.FlxBaseAnimation.set_curIndex","flixel/animation/FlxBaseAnimation.hx",30,0x062a9a5f)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","destroy",0x93a46e09,"flixel.animation.FlxBaseAnimation.destroy","flixel/animation/FlxBaseAnimation.hx",48,0x062a9a5f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(49)
		this->parent = null();
		HX_STACK_LINE(50)
...
{
		HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","update",0xf1225bda,"flixel.animation.FlxBaseAnimation.update","flixel/animation/FlxBaseAnimation.hx",54,0x062a9a5f)
		HX_STACK_THIS(this)
	}
return null();
}
...
::flixel::animation::FlxBaseAnimation FlxBaseAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","clone",0xf2c3a2ac,"flixel.animation.FlxBaseAnimation.clone","flixel/animation/FlxBaseAnimation.hx",58,0x062a9a5f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Parent,"Parent")
	HX_STACK_LINE(58)
	return null();
...
void FlxBaseAnimation_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(exsit,"exsit");
...
void FlxBaseAnimation_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(exsit,"exsit");
...
Dynamic FlxBaseAnimation_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"exsit") ) { return exsit; }
...
Dynamic FlxBaseAnimation_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"exsit") ) { exsit=inValue.Cast< bool >(); return inValue; }
		break;
	case 6:
...
void FlxBaseAnimation_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("exsit"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(FlxBaseAnimation_obj,exsit),HX_CSTRING("exsit")},
