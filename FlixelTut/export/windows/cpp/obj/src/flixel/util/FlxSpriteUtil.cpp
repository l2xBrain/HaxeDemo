...
::flixel::FlxSprite FlxSpriteUtil_obj::alphaMask( ::flixel::FlxSprite output,Dynamic source,Dynamic mask){
	...
	if ((::Std_obj::is(source,hx::ClassOf< ::String >()))){
		HX_STACK_LINE(56)
		::openfl::_legacy::display::BitmapData _g1;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(56)
		{
			HX_STACK_LINE(56)
		...
		if ((::Std_obj::is(source,hx::ClassOf< ::Class >()))){
			...
			if ((::Std_obj::is(source,hx::ClassOf< ::openfl::_legacy::display::BitmapData >()))){
				HX_STACK_LINE(64)
				::openfl::_legacy::display::BitmapData _g2 = (hx::TCast< openfl::_legacy::display::BitmapData >::cast(source))->clone();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(64)
				data = _g2;
			}
			else{
	...
	if ((::Std_obj::is(mask,hx::ClassOf< ::String >()))){
		...
		HX_STACK_LINE(73)
		{
			...
			if (((bd == null()))){
				HX_STACK_LINE(73)
				::openfl::_legacy::display::BitmapData _g3 = ::openfl::_legacy::Assets_obj::getBitmapData(id,false);		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(73)
				bd = _g3;
			}
			HX_STACK_LINE(73)
	...
	HX_STACK_LINE(88)
	int _g5 = data->get_width();		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(88)
	int _g6 = data->get_height();		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(88)
	::openfl::_legacy::geom::Rectangle _g7 = ::openfl::_legacy::geom::Rectangle_obj::__new((int)0,(int)0,_g5,_g6);		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(88)
	::openfl::_legacy::geom::Point _g8 = ::openfl::_legacy::geom::Point_obj::__new(null(),null());		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(88)
	data->copyChannel(maskData,_g7,_g8,(int)8,(int)8);
	HX_STACK_LINE(89)
