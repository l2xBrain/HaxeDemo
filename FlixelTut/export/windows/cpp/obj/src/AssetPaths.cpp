...
::String AssetPaths_obj::gameTile__tmx;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(AssetPaths_obj::gameTile__tmx,"gameTile__tmx");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(AssetPaths_obj::gameTile__tmx,"gameTile__tmx");
...
void AssetPaths_obj::__boot()
{
	...
	gameTile__tmx= HX_CSTRING("assets/data/gameTile.tmx");
