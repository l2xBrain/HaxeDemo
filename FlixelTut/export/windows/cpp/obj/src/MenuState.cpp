...
{
		HX_STACK_FRAME("MenuState","destroy",0xf9ac905e,"MenuState.destroy","MenuState.hx",32,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(32)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",40,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		this->super::update();
	}
...
Void MenuState_obj::clickPlay( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		::haxe::Log_obj::trace(HX_CSTRING("click"),hx::SourceInfo(HX_CSTRING("MenuState.hx"),47,HX_CSTRING("MenuState"),HX_CSTRING("clickPlay")));
		HX_STACK_LINE(48)
		{
			HX_STACK_LINE(48)
