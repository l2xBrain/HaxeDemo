...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","E:\\Haxe\\haxe\\std/cpp/_std/Date.hx",31,0x321f5364)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","E:\\Haxe\\haxe\\std/cpp/_std/Date.hx",57,0x321f5364)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
