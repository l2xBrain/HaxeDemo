...
{
		HX_STACK_FRAME("cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","E:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",38,0xef30bedb)
		HX_STACK_THIS(this)
...
Dynamic Thread_obj::readMessage( bool block){
	HX_STACK_FRAME("cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","E:\\Haxe\\haxe\\std/cpp/vm/Thread.hx",62,0xef30bedb)
